...
class Router
{
   ...
   /**
     ...
     * Sets the $params if route is found.
     * 
...
/**
     ...
     * query string is used for the route, any variables at the end will 
    ...
    /**
     * Get the namespace fot the controller class. The namespace defined in the
